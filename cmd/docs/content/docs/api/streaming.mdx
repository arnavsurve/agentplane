---
title: Streaming API
description: Live responses via Server‑Sent Events (SSE).
---
...
Live responses as they’re generated. Great for chat UIs and progress.
...
### `tool_event`
Emitted when tools run. Shape matches the server’s ToolCallEvent:
...
<Callout type="note">
Tool result strings can be long. In streaming, very large results may be truncated for transport safety.
</Callout>
